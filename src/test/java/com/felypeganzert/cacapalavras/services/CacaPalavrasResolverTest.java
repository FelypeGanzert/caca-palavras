...
public class CacaPalavrasResolverTest {
    ...
    public void deveEncontrarPalavraNaDiagonalParaNoroeste() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "E D E S T x x E", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x T x x x x A x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x A S x x S x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "W x x E E x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x D O x x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x A x x R Ã x", 6);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x S x É x x O x", 7);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "N x x x N O R N", 8);
    ...
    public void deveEncontrarPalavraNaHorizontalParaNorte() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x x O S T P", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "A E x x x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x T x E S x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x R T S E O", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x O T x E x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x N x A x x", 6);
    ...
    public void deveEncontrarPalavraNaDiagonalParaNordeste() {
        CacaPalavras cacaPalavras = new CacaPalavras();
        Tabuleiro tabuleiro8x8 = new Tabuleiro(8,8);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x D E S T x x E", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x x x x T x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x A x x x S x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "W x x x E x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x D x x x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x R x x x Ã x", 6);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x O x É x x x x", 7);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "N x x x N O R x", 8);
        cacaPalavras.setTabuleiro(tabuleiro8x8);
    ...
    public void deveEncontrarPalavraNaHorizontalParaOeste() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x x O S T P x", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "A A x x x x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x x x E S x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x E T S E O x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x x T x E x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x S x A x x W", 6);
    ...
    public void deveEncontrarPalavraNaHorizontalParaLeste() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "A A x x x x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x x x E S x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x L E S T E x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x x T x E x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro7X6, "x S x A x x W", 6);
        cacaPalavras.setTabuleiro(tabuleiro7X6);
    ...
    public void deveEncontrarPalavraNaDiagonalParaSudoeste() {
        CacaPalavras cacaPalavras = new CacaPalavras();
        Tabuleiro tabuleiro8x8 = new Tabuleiro(8,8);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x D E S T x x S", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x x x x U x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x A x x x D x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "W x x x O x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x E x x x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x S x x x Ã x", 6);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x T x É x x x x", 7);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "E x x x N O R x", 8);
        cacaPalavras.setTabuleiro(tabuleiro8x8);
    ...
    public void deveEncontrarPalavraNaHorizontalParaSul() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x x O S T P", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "A E x x x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x S x E S x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x U x S E O", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x L x x E x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro6X6, "x N x A x x", 6);
        cacaPalavras.setTabuleiro(tabuleiro6X6);
    ...
    public void deveEncontrarPalavraNaDiagonalParaSudeste() {
        CacaPalavras cacaPalavras = new CacaPalavras();
        Tabuleiro tabuleiro8x8 = new Tabuleiro(8,8);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "S D E S T x x E", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x U x x x x A x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x A D x x S x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "W x x E E x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x D S x x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x A x x T Ã x", 6);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x S x É x x E x", 7);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "N x x x N O R N", 8);
        cacaPalavras.setTabuleiro(tabuleiro8x8);
    ...
    public void deveEncontrarAMesmaPalavraNaDiagonalParaNoroesteENaVerticalParaNorte() {
        CacaPalavras cacaPalavras = new CacaPalavras();
        Tabuleiro tabuleiro8x8 = new Tabuleiro(8,8);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x A B E x Q x", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x S x E L x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x A A B A x H x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x H H x x A", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x R x D L T D x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x x x E E x x", 6);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x S x x B x B x", 7);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x8, "x x E x A x x A", 8);
        cacaPalavras.setTabuleiro(tabuleiro8x8);
    ...
    public void deveEncontrarPalavrasQueFazemParteDeOutraNaHorizontalParaLeste() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "N A M O R A D A", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 6);
    ...
    public void naoDeveEncontrarNenhumaPalavra() {
        ...
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 6);
        cacaPalavras.setTabuleiro(tabuleiro8x6);
    ...
    public void naoDeveEncontrarNenhumaPalavraQuandoUmaQuaseCorresponder() {
        ...
        Tabuleiro tabuleiro8x6 = new Tabuleiro(8,6);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x x x x x x x", 1);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x P A L V R x x", 2);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "A x x x x x A x", 3);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x R x x x x x x", 4);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "x x V A L A P x", 5);
        CacaPalavrasCreator.inserirLetrasNaLinha(tabuleiroService, tabuleiro8x6, "A R x x x x x x", 6);
        cacaPalavras.setTabuleiro(tabuleiro8x6);
        Palavra palavra = new Palavra();
        palavra.setPalavra("palavra");
        cacaPalavras.getPalavras().add(palavra);
